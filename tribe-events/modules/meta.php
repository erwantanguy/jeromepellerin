...
<?php if ( $not_skeleton ) : ?>
	<div class="row"><!-- tribe-events-single-section tribe-events-event-meta primary tribe-clearfix -->
<?php endif; ?>
...
if ( ! $set_venue_apart && ! tribe_embed_google_map() ) {
	...
	tribe_get_template_part( 'modules/meta/venue' );
	echo '<div class="col-md-12">';//tribe-events-meta-group tribe-events-meta-group-gmap
