...
<form method="post" action="options.php">
	...
	<input type="url" name="spotify" id="spotify" value="<?php echo get_option('spotify'); ?>">
        ...
        <label>Tumblr</label>
	<input type="url" name="tumblr" id="tumblr" value="<?php echo get_option('tumblr'); ?>">
...
<input type="hidden" name="page_options" value="linkedin, tumblr, google, mail, spotify, maintenance, facebook, twitter, instagram, pinterest, flickr" />
