      ...
      <div role="listbox" class="carousel-inner">
          ...
          <?php 
				...
				<div class="carousel-caption">
					<?php if(get_field('titre')){ ?>
                                        ...
                                        <?php if(get_field('sous-titre')){?><h4><?php the_field('sous-titre'); ?></h4><?php }?>
                                    <?php }
                                    else {?>
        ...
        <?php endwhile;   }
        	...
        	<div class="item">
                    <a href="<?php the_permalink();?>"><img alt="First slide [900x500]" src="<?php header_image(); ?>" alt="<?php bloginfo( 'description' ); ?>"></a>
        	</div>
        <?php }?>
      </div>
      <?php if ( $ajax_query->have_posts() ) { ?>
